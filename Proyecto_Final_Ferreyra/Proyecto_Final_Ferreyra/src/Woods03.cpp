...
Woods03::Woods03(const std::string& filePath, ManagersData& managersData) : Map(filePath, managersData)
{
	...
	goToWoods02 = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 1275.0f, 320.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 126)), true, [this]() { this->LoadLevel(MapID::Woods02, { 1205.0f, 340.0f }); });
