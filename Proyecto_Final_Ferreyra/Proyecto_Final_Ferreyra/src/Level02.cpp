...
Level02::Level02(const std::string& filePath, ResourceManager& resourceManager, Dialog& dialog) : Map(filePath, resourceManager, dialog)
{
	...
	goToHouse = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 1280.0f - 380.0f, 0.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 40)), true, [this]() { this->LoadHouse(); });
	goToCave = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 200.0f, 1280.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 40)), true, [this]() { this->LoadCave(); });
	goToWoods01 = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 0.0f, 150.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 40)), true, [this]() { this->LoadWoods01(); });
