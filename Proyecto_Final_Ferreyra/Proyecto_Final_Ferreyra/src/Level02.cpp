...
Level02::Level02(const std::string& filePath, ManagersData& managersData) : Map(filePath, managersData)
{
	...
	goToHouse = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 1280.0f - 380.0f, -100.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 126)), true, [this]() { this->LoadLevel(MapID::OldWomanHouse, { 950.0f, 100.0f}); });
	goToCave = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 400.0f, 700.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 126)), true, [this]() { this->LoadLevel(MapID::Cave, { 400.0f, 600.0f }); });
	goToWoods01 = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ -100.0f, 720.0f - 600.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 126)), true, [this]() { this->LoadLevel(MapID::Woods01, { 64.0f, 140.0f }); });
	woodsDoor = new InteractableAsset(&resourceManager.GetTexture("../textures/woodsDoor.png", false, sf::IntRect()), sf::Vector2f{ 10.0f, 100.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(59, 195)), true, [this]() {this->WoodsDoorInteraction(); });
