...
Level01::Level01(const std::string& filePath, ManagersData& managersData) : Map(filePath,managersData)
{
	...
	goToWoods = new TriggerAsset(&resourceManager.GetTexture("../textures/changeMapCollision.png", false, sf::IntRect()), sf::Vector2f{ 1280.0f - 720.0f, 720.0f - 20.0f }, sf::IntRect(sf::Vector2i(0, 0), sf::Vector2i(126, 126)), true, [this]() { this->LoadLevel(MapID::Camp, { 1280.0f - 680.0f, 720.0f - 150.0f }); });
