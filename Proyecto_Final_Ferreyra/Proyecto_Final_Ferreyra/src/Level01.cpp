...
bool Level01::CheckCollision(const sf::FloatRect& playerBounds, bool isInteractable)
{
	/*if (doorToWoods->GetSprite()->getGlobalBounds().findIntersection(playerBounds))
	{
		
		return true;
	}*/
	Map::CheckCollision(playerBounds, isInteractable);
	return false;
}
